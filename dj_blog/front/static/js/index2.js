...
function selectLanguage(e) {
    ...
    const params = {
        'i18n': true,
        'filtro': `&active=1&internal=0&layout_root_alias=asinex2`,
        'idElement': 'note',
    }     
...
async function loadPage(page, language) {
    const filtro = `?format=json&layout_root_alias=asinex2&note=${page}&grade=${language}`;
...
async function loadSubMenu(item) {
    ...
    filtro = `format=json&active=1&root_alias=asinex2&${filtro}`;
...
function iniciar() {
    ...
    params = {
        'i18n': false,
        'filtro': `&active=1&internal=0&root_alias__=asinex2`,
        'idElement': 'grade', 
